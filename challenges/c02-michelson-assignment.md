...
- All of these measurements are higher than the actual value of the
  speed of light

<!-- -->

- The higher the quality of picture, the higher the measured value of
  the speed of light

- There were more high quality photos than there were low quality photos

Why might your table differ from Michelson’s?

- He may have had less computational power, and so rounded to a few
...
- Michelson’s estimate: 51

- True error was greater

\- Make a quantitative comparison between Michelson’s uncertainty and
his error.

- His uncertainty was significantly lesser than his error. His
  uncertainty “value” was about a third of his error value
...
- The days on which the measurements generally increased or decreased
  parallel one another, assumedly because the situation takes into
  account the temperature on the days that he was measuring

- The means of the measurements generally tend within the error bound
  Michelson gave (50 above or below his appx speed of light measurement

Differences -

- The real measurements seem to vary a little bit more at the beginning,
  possibly because of measurement errors, possibly because of random
  chance
...
df_q2 %>% 
  ggplot() + 
  geom_boxplot(mapping = aes(x = Distinctness, y = Temp))
```
...
- There seems like mayyybe a slight trend upwards in velocity as
  temperature increases? But generally the scatterplot doesn’t seem to
  indicate a trend in temperature and velocity, which may have been the
  conclusion Michelson came to, so he didn’t account for enough of an
  impact that a non-vacuum had on the speed of light
- Additionally, the distinctness of the photo does not seem to really
  affect the quality of the measurement, except for possibly a few
  outliers near the low end of temperature.
