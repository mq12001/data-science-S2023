...
- Write your observations here
  - Very small difference, only off by 1
- Are there any differences?
  - 2201 in this dataset

  - 2202 accounted for on the wikipedia page -

    - 885 crew

    - 1,317 passengers
- If yes, what might account for those differences?
  - Maybe a stowaway that was eventually in the data for Wikipedia, but
    not accounted for on this manifest?
...
- These differences may be because there were many more crew in general
  ...
  - And most crew were men
- Proportion would be more useful here
...
- As I thought, more women from each group survived and there were far
  fewer crew that survived compared to their total population in general
- Is there anything *fishy* going on in your plot?
  - The proportion is \>1 for some of these groups? More than 100% of
    the men in first class survived, as will as something around 200% of
    the first class women.
    - This is because the groups were sorted by age and THEN added
      together
...
- 100% of 1st and 2nd class children survived! Cool
- The likelihood of surviving if you are a man goes WAY up if you are
  also a child -
  - Most of the adults that survived, proportion-wise, were female
- If you saw something *fishy* in q4 above, use your new plot to explain
  the fishy-ness.
  - No proportion is over 1 now, thankfully.
    - I do find it a little strange that some proportions are exactly 1?
      Just a skeptic

    - But its no longer nonsensical, data-wise

    - Just a little bit of an alarm raiser, real-world-odds-wise
  - some of the proportions Do add up to over one before being divided
    - Like 1st class women, whom it seems do in fact have a 100%
      survival rate, whether adult or child
