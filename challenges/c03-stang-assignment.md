...
- Is there “one true value” for the material properties of Aluminum?
  - No, there is a range that the material properties are going to lie
    in, and analysis of data will allow us to determine that range.
- How many aluminum alloys are in this dataset? How do you know?
  - One, there is only one type listed as an alloy, al_24st
...
- The angle doesn’t seem to affect the material properties with any
  reliability, but nu and E are definitely positively correlated.
